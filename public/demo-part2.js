...
return`<div class="cd ${i===1?'glow-accent':''}" style="${i===1?'border-color:var(--accent)':''}">
...
<div style="width:40px;height:40px;border-radius:12px;background:${i===1?'var(--accent-bg)':i===0?'var(--ai-bg)':'var(--warn-bg)'};display:flex;align-items:center;justify-content:center;font-size:20px">${icons[i]}</div>
...
<div class="li-icon" style="background:${st==='open'?'var(--accent-bg)':st==='replied'?'var(--ai-bg)':'var(--warn-bg)'}"><svg style="color:${st==='open'?'var(--accent)':st==='replied'?'var(--ai)':'var(--warn)'}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg></div>
...
<div style="margin-top:12px"><div style="font-size:11px;color:var(--fg4);margin-bottom:4px">REFERRAL LINK</div><div class="invite-link">https://xboard.example.com/register?code=***
</div></div>
<div class="cd"><div class="cd-body">
...
<div style="width:44px;height:44px;border-radius:12px;background:var(--accent-bg);display:flex;align-items:center;justify-content:center"><svg style="width:22px;height:22px;color:var(--accent)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m21 2-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.78 7.78 5.5 5.5 0 0 1 7.78-7.78Z"/><path d="M15.5 15.5 21 21"/></svg></div>
...
<div style="background:var(--bg);border:1px dashed var(--bdr2);border-radius:8px;padding:16px;font-family:var(--mono);font-size:12px;word-break:break-all;color:var(--fg2);line-height:1.6">https://x.example.com/api/v1/client/subscribe?token=*** style="display:flex;gap:10px;margin-top:14px">
...
<div class="client-card"><div style="display:flex;align-items:center;gap:10px"><div style="width:36px;height:36px;border-radius:8px;background:var(--ai-bg);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:var(--ai)">C</div><div><div style="font-size:13px;font-weight:600">Clash</div><div style="font-size:11px;color:var(--fg4)">Windows / macOS / Linux</div></div></div></div>
<div class="client-card"><div style="display:flex;align-items:center;gap:10px"><div style="width:36px;height:36px;border-radius:8px;background:var(--ai-bg);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:var(--ai)">S</div><div><div style="font-size:13px;font-weight:600">Shadowrocket</div><div style="font-size:11px;color:var(--fg4)">iOS</div></div></div></div>
<div class="client-card"><div style="display:flex;align-items:center;gap:10px"><div style="width:36px;height:36px;border-radius:8px;background:var(--ai-bg);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:var(--ai)">V</div><div><div style="font-size:13px;font-weight:600">V2rayN</div><div style="font-size:11px;color:var(--fg4)">Windows</div></div></div></div>
<div class="client-card"><div style="display:flex;align-items:center;gap:10px"><div style="width:36px;height:36px;border-radius:8px;background:var(--ai-bg);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:var(--ai)">Q</div><div><div style="font-size:13px;font-weight:600">Quantumult X</div><div style="font-size:11px;color:var(--fg4)">iOS</div></div></div></div>
...
${status==='Replied'?`<div class="msg-right"><div style="width:28px;height:28px;border-radius:50%;background:var(--ai-bg);display:flex;align-items:center;justify-content:center;font-size:11px;color:var(--ai);flex-shrink:0">S</div><div><div class="msg-bubble">Thank you for reaching out. We have forwarded this to our technical team. Could you please share your subscription link and the error log?</div><div class="msg-time">2026-05-21 10:30</div></div></div>`:''}
