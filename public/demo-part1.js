...
<div class="cd ani ani1" style="background:linear-gradient(135deg,rgba(34,197,94,.08),rgba(99,102,241,.04));border-color:rgba(34,197,94,.15);padding:14px 18px;margin-bottom:20px;display:flex;align-items:center;gap:12px">
